...
// @generated from file tc_models.proto (package tc, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum tc.AudioCodec
 */
...
proto3.util.setEnumType(AudioCodec, "tc.AudioCodec", [
...
/**
 * @generated from enum tc.VideoCodec
 */
...
proto3.util.setEnumType(VideoCodec, "tc.VideoCodec", [
...
/**
 * @generated from enum tc.ImageCodec
 */
...
proto3.util.setEnumType(ImageCodec, "tc.ImageCodec", [
  { no: 0, name: "IC_DEFAULT" },
  { no: 1, name: "IC_JPEG" },
]);

/**
 * @generated from enum tc.TrackType
 */
...
/**
 * @generated from enum tc.TrackSource
 */
...
/**
 * @generated from enum tc.VideoQuality
 */
...
/**
 * @generated from enum tc.ConnectionQuality
 */
...
proto3.util.setEnumType(ConnectionQuality, "tc.ConnectionQuality", [
  { no: 0, name: "POOR" },
  { no: 1, name: "GOOD" },
  { no: 2, name: "EXCELLENT" },
]);
...
/**
 * @generated from enum tc.ClientConfigSetting
 */
...
proto3.util.setEnumType(ClientConfigSetting, "tc.ClientConfigSetting", [
  { no: 0, name: "UNSET" },
  { no: 1, name: "DISABLED" },
  { no: 2, name: "ENABLED" },
]);
...
/**
 * @generated from enum tc.DisconnectReason
 */
...
proto3.util.setEnumType(DisconnectReason, "tc.DisconnectReason", [
...
/**
 * @generated from enum tc.ReconnectReason
 */
...
proto3.util.setEnumType(ReconnectReason, "tc.ReconnectReason", [
...
/**
 * @generated from enum tc.SubscriptionError
 */
...
proto3.util.setEnumType(SubscriptionError, "tc.SubscriptionError", [
...
/**
 * @generated from message tc.Room
 */
export class Room extends Message<Room> {
  ...
  /**
   * @generated from field: repeated tc.Codec enabled_codecs = 7;
   */
  enabledCodecs: Codec[] = [];
  ...
  static readonly typeName = "tc.Room";
...
/**
 * @generated from message tc.Codec
 */
export class Codec extends Message<Codec> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.Codec";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.PlayoutDelay
 */
export class PlayoutDelay extends Message<PlayoutDelay> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.PlayoutDelay";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ParticipantPermission
 */
export class ParticipantPermission extends Message<ParticipantPermission> {
   ...
   *
   * @generated from field: repeated tc.TrackSource can_publish_sources = 9;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ParticipantPermission";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ParticipantInfo
 */
export class ParticipantInfo extends Message<ParticipantInfo> {
  ...
  /**
   * @generated from field: tc.ParticipantInfo.State state = 3;
   */
  state = ParticipantInfo_State.JOINING;

  /**
   * @generated from field: repeated tc.TrackInfo tracks = 4;
   */
  tracks: TrackInfo[] = [];
  ...
  /**
   * @generated from field: tc.ParticipantPermission permission = 11;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ParticipantInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from enum tc.ParticipantInfo.State
 */
...
proto3.util.setEnumType(ParticipantInfo_State, "tc.ParticipantInfo.State", [
  { no: 0, name: "JOINING" },
  { no: 1, name: "JOINED" },
  { no: 2, name: "ACTIVE" },
...
/**
 * @generated from message tc.Encryption
 */
export class Encryption extends Message<Encryption> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.Encryption";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from enum tc.Encryption.Type
 */
...
proto3.util.setEnumType(Encryption_Type, "tc.Encryption.Type", [
  { no: 0, name: "NONE" },
  { no: 1, name: "GCM" },
  { no: 2, name: "CUSTOM" },
]);
...
/**
 * @generated from message tc.SimulcastCodecInfo
 */
export class SimulcastCodecInfo extends Message<SimulcastCodecInfo> {
  ...
  /**
   * @generated from field: repeated tc.VideoLayer layers = 4;
   */
  layers: VideoLayer[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SimulcastCodecInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.TrackInfo
 */
export class TrackInfo extends Message<TrackInfo> {
  ...
  /**
   * @generated from field: tc.TrackType type = 2;
   */
   ...
   * source of media
   *
   * @generated from field: tc.TrackSource source = 9;
   */
  source = TrackSource.UNKNOWN;

  /**
   * @generated from field: repeated tc.VideoLayer layers = 10;
   */
  layers: VideoLayer[] = [];
  ...
  /**
   * @generated from field: repeated tc.SimulcastCodecInfo codecs = 13;
   */
  ...
  /**
   * @generated from field: tc.Encryption.Type encryption = 16;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.TrackInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tc.VideoLayer
 */
export class VideoLayer extends Message<VideoLayer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.VideoLayer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * new DataPacket API
 *
 * @generated from message tc.DataPacket
 */
export class DataPacket extends Message<DataPacket> {
  /**
   * @generated from field: tc.DataPacket.Kind kind = 1;
   */
  kind = DataPacket_Kind.RELIABLE;

  /**
   * @generated from oneof tc.DataPacket.value
   */
  value: {
    /**
     * @generated from field: tc.UserPacket user = 2;
     */
    value: UserPacket;
    case: "user";
  } | {
    /**
     * @generated from field: tc.ActiveSpeakerUpdate speaker = 3;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DataPacket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum tc.DataPacket.Kind
 */
...
proto3.util.setEnumType(DataPacket_Kind, "tc.DataPacket.Kind", [
  { no: 0, name: "RELIABLE" },
  { no: 1, name: "LOSSY" },
]);

/**
 * @generated from message tc.ActiveSpeakerUpdate
 */
export class ActiveSpeakerUpdate extends Message<ActiveSpeakerUpdate> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ActiveSpeakerUpdate";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.SpeakerInfo
 */
export class SpeakerInfo extends Message<SpeakerInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SpeakerInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.UserPacket
 */
export class UserPacket extends Message<UserPacket> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UserPacket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ParticipantTracks
 */
export class ParticipantTracks extends Message<ParticipantTracks> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ParticipantTracks";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "participant_sid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tc.ServerInfo
 */
export class ServerInfo extends Message<ServerInfo> {
  /**
   * @generated from field: tc.ServerInfo.Edition edition = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ServerInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum tc.ServerInfo.Edition
 */
...
proto3.util.setEnumType(ServerInfo_Edition, "tc.ServerInfo.Edition", [
  { no: 0, name: "Standard" },
  { no: 1, name: "Cloud" },
]);
 ...
 *
 * @generated from message tc.ClientInfo
 */
export class ClientInfo extends Message<ClientInfo> {
  /**
   * @generated from field: tc.ClientInfo.SDK sdk = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ClientInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum tc.ClientInfo.SDK
 */
...
proto3.util.setEnumType(ClientInfo_SDK, "tc.ClientInfo.SDK", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "JS" },
  { no: 2, name: "SWIFT" },
  { no: 3, name: "ANDROID" },
 ...
 *
 * @generated from message tc.ClientConfiguration
 */
export class ClientConfiguration extends Message<ClientConfiguration> {
  /**
   * @generated from field: tc.VideoConfiguration video = 1;
   */
  video?: VideoConfiguration;

  /**
   * @generated from field: tc.VideoConfiguration screen = 2;
   */
  screen?: VideoConfiguration;

  /**
   * @generated from field: tc.ClientConfigSetting resume_connection = 3;
   */
  resumeConnection = ClientConfigSetting.UNSET;

  /**
   * @generated from field: tc.DisabledCodecs disabled_codecs = 4;
   */
  disabledCodecs?: DisabledCodecs;

  /**
   * @generated from field: tc.ClientConfigSetting force_relay = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ClientConfiguration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.VideoConfiguration
 */
export class VideoConfiguration extends Message<VideoConfiguration> {
  /**
   * @generated from field: tc.ClientConfigSetting hardware_encoder = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.VideoConfiguration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.DisabledCodecs
 */
export class DisabledCodecs extends Message<DisabledCodecs> {
  /**
   * disabled for both publish and subscribe
   *
   * @generated from field: repeated tc.Codec codecs = 1;
   */
  codecs: Codec[] = [];
   ...
   *
   * @generated from field: repeated tc.Codec publish = 2;
   */
  publish: Codec[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DisabledCodecs";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.RTPDrift
 */
export class RTPDrift extends Message<RTPDrift> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.RTPDrift";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.RTPStats
 */
export class RTPStats extends Message<RTPStats> {
  ...
  /**
   * @generated from field: tc.RTPDrift packet_drift = 44;
   */
   ...
   * NEXT_ID: 46
   *
   * @generated from field: tc.RTPDrift report_drift = 45;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.RTPStats";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "start_time", kind: "message", T: Timestamp },
    { no: 2, name: "end_time", kind: "message", T: Timestamp },
    { no: 3, name: "duration", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
...
/**
 * @generated from message tc.TimedVersion
 */
export class TimedVersion extends Message<TimedVersion> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.TimedVersion";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
