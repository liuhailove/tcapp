...
// @generated from file tc_ingress.proto (package tc, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3, protoInt64 } from "@bufbuild/protobuf";
import { AudioCodec, TrackInfo, TrackSource, VideoCodec, VideoLayer } from "./tc_models_pb.js";

/**
 * @generated from enum tc.IngressInput
 */
...
proto3.util.setEnumType(IngressInput, "tc.IngressInput", [
...
/**
 * @generated from enum tc.IngressAudioEncodingPreset
 */
...
proto3.util.setEnumType(IngressAudioEncodingPreset, "tc.IngressAudioEncodingPreset", [
  { no: 0, name: "OPUS_STEREO_96KBPS" },
  { no: 1, name: "OPUS_MONO_64KBS" },
]);

/**
 * @generated from enum tc.IngressVideoEncodingPreset
 */
...
proto3.util.setEnumType(IngressVideoEncodingPreset, "tc.IngressVideoEncodingPreset", [
...
/**
 * @generated from message tc.CreateIngressRequest
 */
export class CreateIngressRequest extends Message<CreateIngressRequest> {
  /**
   * @generated from field: tc.IngressInput input_type = 1;
   */
  ...
  /**
   * @generated from field: tc.IngressAudioOptions audio = 6;
   */
  audio?: IngressAudioOptions;

  /**
   * @generated from field: tc.IngressVideoOptions video = 7;
   */
  ...
  static readonly typeName = "tc.CreateIngressRequest";
...
/**
 * @generated from message tc.IngressAudioOptions
 */
export class IngressAudioOptions extends Message<IngressAudioOptions> {
  ...
  /**
   * @generated from field: tc.TrackSource source = 2;
   */
  source = TrackSource.UNKNOWN;

  /**
   * @generated from oneof tc.IngressAudioOptions.encoding_options
   */
  encodingOptions: {
    /**
     * @generated from field: tc.IngressAudioEncodingPreset preset = 3;
     */
    value: IngressAudioEncodingPreset;
    case: "preset";
  } | {
    /**
     * @generated from field: tc.IngressAudioEncodingOptions options = 4;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressAudioOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.IngressVideoOptions
 */
export class IngressVideoOptions extends Message<IngressVideoOptions> {
  ...
  /**
   * @generated from oneof tc.IngressVideoOptions.encoding_options
   */
  encodingOptions: {
    /**
     * @generated from field: tc.IngressVideoEncodingPreset preset = 3;
     */
    value: IngressVideoEncodingPreset;
    case: "preset";
  } | {
    /**
     * @generated from field: tc.IngressVideoEncodingOptions options = 4;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressVideoOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "source", kind: "enum", T: proto3.getEnumType(TrackSource) },
...
/**
 * @generated from message tc.IngressAudioEncodingOptions
 */
export class IngressAudioEncodingOptions extends Message<IngressAudioEncodingOptions> {
   ...
   *
   * @generated from field: tc.AudioCodec audio_codec = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressAudioEncodingOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class IngressVideoEncodingOptions extends Message<IngressVideoEncodingOptions> {
   ...
   *
   * @generated from field: repeated tc.VideoLayer layers = 3;
   */
  layers: VideoLayer[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressVideoEncodingOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.IngressInfo
 */
export class IngressInfo extends Message<IngressInfo> {
   ...
   *
   * @generated from field: tc.IngressInput input_type = 5;
   */
  inputType = IngressInput.RTMP_INPUT;
   ...
   *
   * @generated from field: tc.IngressState state = 12;
   */
  state?: IngressState;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.IngressState
 */
export class IngressState extends Message<IngressState> {
  /**
   * @generated from field: tc.IngressState.Status status = 1;
   */
  ...
  /**
   * @generated from field: tc.InputVideoState video = 3;
   */
  video?: InputVideoState;

  /**
   * @generated from field: tc.InputAudioState audio = 4;
   */
  ...
  /**
   * @generated from field: repeated tc.TrackInfo tracks = 6;
   */
  tracks: TrackInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.IngressState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum tc.IngressState.Status
 */
...
proto3.util.setEnumType(IngressState_Status, "tc.IngressState.Status", [
...
/**
 * @generated from message tc.InputVideoState
 */
export class InputVideoState extends Message<InputVideoState> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.InputVideoState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.InputAudioState
 */
export class InputAudioState extends Message<InputAudioState> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.InputAudioState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "mime_type", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "average_bitrate", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
...
/**
 * @generated from message tc.UpdateIngressRequest
 */
export class UpdateIngressRequest extends Message<UpdateIngressRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateIngressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "ingress_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "room_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.ListIngressRequest
 */
export class ListIngressRequest extends Message<ListIngressRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListIngressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ListIngressResponse
 */
export class ListIngressResponse extends Message<ListIngressResponse> {
  /**
   * @generated from field: repeated tc.IngressInfo items = 1;
   */
  items: IngressInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListIngressResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.DeleteIngressRequest
 */
export class DeleteIngressRequest extends Message<DeleteIngressRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DeleteIngressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "ingress_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
