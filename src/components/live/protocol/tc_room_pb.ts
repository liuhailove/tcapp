...
// @generated from file tc_room.proto (package tc, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { AutoParticipantEgress, AutoTrackEgress, RoomCompositeEgressRequest } from "./tc_egress_pb.js";
import { DataPacket_Kind, ParticipantInfo, ParticipantPermission, ParticipantTracks, Room, TrackInfo } from "./tc_models_pb.js";

/**
 * @generated from message tc.CreateRoomRequest
 */
export class CreateRoomRequest extends Message<CreateRoomRequest> {
   ...
   * egress
   *
   * @generated from field: tc.RoomEgress egress = 6;
   */
  egress?: RoomEgress;
  ...
  static readonly typeName = "tc.CreateRoomRequest";
...
/**
 * @generated from message tc.RoomEgress
 */
export class RoomEgress extends Message<RoomEgress> {
  /**
   * @generated from field: tc.RoomCompositeEgressRequest room = 1;
   */
  room?: RoomCompositeEgressRequest;

  /**
   * @generated from field: tc.AutoParticipantEgress participant = 3;
   */
  participant?: AutoParticipantEgress;

  /**
   * @generated from field: tc.AutoTrackEgress tracks = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.RoomEgress";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ListRoomsRequest
 */
export class ListRoomsRequest extends Message<ListRoomsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListRoomsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ListRoomsResponse
 */
export class ListRoomsResponse extends Message<ListRoomsResponse> {
  /**
   * @generated from field: repeated tc.Room rooms = 1;
   */
  rooms: Room[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListRoomsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.DeleteRoomRequest
 */
export class DeleteRoomRequest extends Message<DeleteRoomRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DeleteRoomRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.DeleteRoomResponse
 */
export class DeleteRoomResponse extends Message<DeleteRoomResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DeleteRoomResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message tc.ListParticipantsRequest
 */
export class ListParticipantsRequest extends Message<ListParticipantsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListParticipantsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message tc.ListParticipantsResponse
 */
export class ListParticipantsResponse extends Message<ListParticipantsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListParticipantsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.RoomParticipantIdentity
 */
export class RoomParticipantIdentity extends Message<RoomParticipantIdentity> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.RoomParticipantIdentity";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.RemoveParticipantResponse
 */
export class RemoveParticipantResponse extends Message<RemoveParticipantResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.RemoveParticipantResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message tc.MuteRoomTrackRequest
 */
export class MuteRoomTrackRequest extends Message<MuteRoomTrackRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.MuteRoomTrackRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.MuteRoomTrackResponse
 */
export class MuteRoomTrackResponse extends Message<MuteRoomTrackResponse> {
  /**
   * @generated from field: tc.TrackInfo track = 1;
   */
  track?: TrackInfo;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.MuteRoomTrackResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.UpdateParticipantRequest
 */
export class UpdateParticipantRequest extends Message<UpdateParticipantRequest> {
   ...
   *
   * @generated from field: tc.ParticipantPermission permission = 4;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateParticipantRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.UpdateSubscriptionsRequest
 */
export class UpdateSubscriptionsRequest extends Message<UpdateSubscriptionsRequest> {
   ...
   *
   * @generated from field: repeated tc.ParticipantTracks participant_tracks = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateSubscriptionsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 * empty for now
 *
 * @generated from message tc.UpdateSubscriptionsResponse
 */
export class UpdateSubscriptionsResponse extends Message<UpdateSubscriptionsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateSubscriptionsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message tc.SendDataRequest
 */
export class SendDataRequest extends Message<SendDataRequest> {
  ...
  /**
   * @generated from field: tc.DataPacket.Kind kind = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SendDataRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.SendDataResponse
 */
export class SendDataResponse extends Message<SendDataResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SendDataResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message tc.UpdateRoomMetadataRequest
 */
export class UpdateRoomMetadataRequest extends Message<UpdateRoomMetadataRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateRoomMetadataRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room", kind: "scalar", T: 9 /* ScalarType.STRING */ },
