...
// @generated from file tc_egress.proto (package tc, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3, protoInt64 } from "@bufbuild/protobuf";
import { AudioCodec, ImageCodec, VideoCodec } from "./tc_models_pb.js";

/**
 * @generated from enum tc.EncodedFileType
 */
...
proto3.util.setEnumType(EncodedFileType, "tc.EncodedFileType", [
...
/**
 * @generated from enum tc.SegmentedFileProtocol
 */
...
proto3.util.setEnumType(SegmentedFileProtocol, "tc.SegmentedFileProtocol", [
  { no: 0, name: "DEFAULT_SEGMENTED_FILE_PROTOCOL" },
  { no: 1, name: "HLS_PROTOCOL" },
]);

/**
 * @generated from enum tc.SegmentedFileSuffix
 */
...
proto3.util.setEnumType(SegmentedFileSuffix, "tc.SegmentedFileSuffix", [
  { no: 0, name: "INDEX" },
  { no: 1, name: "TIMESTAMP" },
]);

/**
 * @generated from enum tc.ImageFileSuffix
 */
...
proto3.util.setEnumType(ImageFileSuffix, "tc.ImageFileSuffix", [
  { no: 0, name: "IMAGE_SUFFIX_INDEX" },
  { no: 1, name: "IMAGE_SUFFIX_TIMESTAMP" },
]);

/**
 * @generated from enum tc.StreamProtocol
 */
...
proto3.util.setEnumType(StreamProtocol, "tc.StreamProtocol", [
  { no: 0, name: "DEFAULT_PROTOCOL" },
  { no: 1, name: "RTMP" },
]);

/**
 * @generated from enum tc.EncodingOptionsPreset
 */
...
proto3.util.setEnumType(EncodingOptionsPreset, "tc.EncodingOptionsPreset", [
...
/**
 * @generated from enum tc.EgressStatus
 */
...
proto3.util.setEnumType(EgressStatus, "tc.EgressStatus", [
 ...
 *
 * @generated from message tc.RoomCompositeEgressRequest
 */
export class RoomCompositeEgressRequest extends Message<RoomCompositeEgressRequest> {
   ...
   *
   * @generated from oneof tc.RoomCompositeEgressRequest.output
   */
  output: {
    /**
     * @generated from field: tc.EncodedFileOutput file = 6 [deprecated = true];
     * @deprecated
     */
    ...
    /**
     * @generated from field: tc.StreamOutput stream = 7 [deprecated = true];
     * @deprecated
     */
    value: StreamOutput;
    case: "stream";
    ...
    /**
     * @generated from field: tc.SegmentedFileOutput segments = 10 [deprecated = true];
     * @deprecated
     */
  ...
  /**
   * @generated from oneof tc.RoomCompositeEgressRequest.options
   */
  options: {
    /**
     * (default H264_720P_30)
     *
     * @generated from field: tc.EncodingOptionsPreset preset = 8;
     */
     ...
     * (optional)
     *
     * @generated from field: tc.EncodingOptions advanced = 9;
     */
  ...
  /**
   * @generated from field: repeated tc.EncodedFileOutput file_outputs = 11;
   */
  fileOutputs: EncodedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.StreamOutput stream_outputs = 12;
   */
  streamOutputs: StreamOutput[] = [];

  /**
   * @generated from field: repeated tc.SegmentedFileOutput segment_outputs = 13;
   */
  segmentOutputs: SegmentedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.ImageOutput image_outputs = 14;
   */
  ...
  static readonly typeName = "tc.RoomCompositeEgressRequest";
 ...
 * record any website
 *
 * @generated from message tc.WebEgressRequest
 */
export class WebEgressRequest extends Message<WebEgressRequest> {
   ...
   * deprecated (use _output fields)
   *
   * @generated from oneof tc.WebEgressRequest.output
   */
  output: {
    /**
     * @generated from field: tc.EncodedFileOutput file = 4 [deprecated = true];
     * @deprecated
     */
    value: EncodedFileOutput;
    case: "file";
    ...
    /**
     * @generated from field: tc.StreamOutput stream = 5 [deprecated = true];
     * @deprecated
     */
    value: StreamOutput;
    case: "stream";
    ...
    /**
     * @generated from field: tc.SegmentedFileOutput segments = 6 [deprecated = true];
     * @deprecated
     */
    value: SegmentedFileOutput;
    case: "segments";
  ...
  /**
   * @generated from oneof tc.WebEgressRequest.options
   */
  options: {
    /**
     * @generated from field: tc.EncodingOptionsPreset preset = 7;
     */
    value: EncodingOptionsPreset;
    case: "preset";
  } | {
    /**
     * @generated from field: tc.EncodingOptions advanced = 8;
     */
    value: EncodingOptions;
    case: "advanced";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  /**
   * @generated from field: repeated tc.EncodedFileOutput file_outputs = 9;
   */
  fileOutputs: EncodedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.StreamOutput stream_outputs = 10;
   */
  streamOutputs: StreamOutput[] = [];

  /**
   * @generated from field: repeated tc.SegmentedFileOutput segment_outputs = 11;
   */
  segmentOutputs: SegmentedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.ImageOutput image_outputs = 13;
   */
  imageOutputs: ImageOutput[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.WebEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tc.ParticipantEgressRequest
 */
export class ParticipantEgressRequest extends Message<ParticipantEgressRequest> {
  ...
  /**
   * @generated from oneof tc.ParticipantEgressRequest.options
   */
  options: {
    /**
     * (default H264_720P_30)
     *
     * @generated from field: tc.EncodingOptionsPreset preset = 4;
     */
    value: EncodingOptionsPreset;
    case: "preset";
  } | {
     ...
     * (optional)
     *
     * @generated from field: tc.EncodingOptions advanced = 5;
     */
    value: EncodingOptions;
    case: "advanced";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  /**
   * @generated from field: repeated tc.EncodedFileOutput file_outputs = 6;
   */
  fileOutputs: EncodedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.StreamOutput stream_outputs = 7;
   */
  streamOutputs: StreamOutput[] = [];

  /**
   * @generated from field: repeated tc.SegmentedFileOutput segment_outputs = 8;
   */
  segmentOutputs: SegmentedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.ImageOutput image_outputs = 9;
   */
  imageOutputs: ImageOutput[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ParticipantEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tc.TrackCompositeEgressRequest
 */
export class TrackCompositeEgressRequest extends Message<TrackCompositeEgressRequest> {
   ...
   * deprecated (use _output fields)
   *
   * @generated from oneof tc.TrackCompositeEgressRequest.output
   */
  output: {
    /**
     * @generated from field: tc.EncodedFileOutput file = 4 [deprecated = true];
    ...
    /**
     * @generated from field: tc.SegmentedFileOutput segments = 8 [deprecated = true];
     * @deprecated
     */
    value: SegmentedFileOutput;
    case: "segments";
  ...
  /**
   * @generated from oneof tc.TrackCompositeEgressRequest.options
   */
  options: {
    /**
     * (default H264_720P_30)
     *
     * @generated from field: tc.EncodingOptionsPreset preset = 6;
     */
    value: EncodingOptionsPreset;
    case: "preset";
  } | {
     ...
     * (optional)
     *
     * @generated from field: tc.EncodingOptions advanced = 7;
     */
    value: EncodingOptions;
    case: "advanced";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.TrackCompositeEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message tc.TrackEgressRequest
 */
export class TrackEgressRequest extends Message<TrackEgressRequest> {
   ...
   * required
   *
   * @generated from oneof tc.TrackEgressRequest.output
   */
  output: {
    /**
     * @generated from field: tc.DirectFileOutput file = 3;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.TrackEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.EncodedFileOutput
 */
export class EncodedFileOutput extends Message<EncodedFileOutput> {
  /**
   * (optional)
   *
   * @generated from field: tc.EncodedFileType file_type = 1;
   */
  ...
  /**
   * @generated from oneof tc.EncodedFileOutput.output
   */
  output: {
    /**
     * @generated from field: tc.S3Upload s3 = 3;
     */
    value: S3Upload;
    case: "s3";
  } | {
    /**
     * @generated from field: tc.GCPUpload gcp = 4;
     */
    value: GCPUpload;
    case: "gcp";
  } | {
    /**
     * @generated from field: tc.AzureBlobUpload azure = 5;
     */
    value: AzureBlobUpload;
    case: "azure";
  } | {
    /**
     * @generated from field: tc.AliOSSUpload aliOSS = 7;
     */
    value: AliOSSUpload;
    case: "aliOSS";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.EncodedFileOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message tc.SegmentedFileOutput
 */
export class SegmentedFileOutput extends Message<SegmentedFileOutput> {
  /**
   * (optional)
   *
   * @generated from field: tc.SegmentedFileProtocol protocol = 1;
   */
   ...
   *
   * @generated from field: tc.SegmentedFileSuffix filename_suffix = 10;
   */
   ...
   * required
   *
   * @generated from oneof tc.SegmentedFileOutput.output
   */
  output: {
    /**
     * @generated from field: tc.S3Upload s3 = 5;
     */
    value: S3Upload;
    case: "s3";
  } | {
    /**
     * @generated from field: tc.GCPUpload gcp = 6;
     */
    value: GCPUpload;
    case: "gcp";
  } | {
    /**
     * @generated from field: tc.AzureBlobUpload azure = 7;
     */
    value: AzureBlobUpload;
    case: "azure";
  } | {
    /**
     * @generated from field: tc.AliOSSUpload aliOSS = 9;
     */
    value: AliOSSUpload;
    case: "aliOSS";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SegmentedFileOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.DirectFileOutput
 */
export class DirectFileOutput extends Message<DirectFileOutput> {
  ...
  /**
   * @generated from oneof tc.DirectFileOutput.output
   */
  output: {
    /**
     * @generated from field: tc.S3Upload s3 = 2;
     */
    value: S3Upload;
    case: "s3";
  } | {
    /**
     * @generated from field: tc.GCPUpload gcp = 3;
     */
    value: GCPUpload;
    case: "gcp";
  } | {
    /**
     * @generated from field: tc.AzureBlobUpload azure = 4;
     */
    value: AzureBlobUpload;
    case: "azure";
  } | {
    /**
     * @generated from field: tc.AliOSSUpload aliOSS = 6;
     */
    value: AliOSSUpload;
    case: "aliOSS";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.DirectFileOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ImageOutput
 */
export class ImageOutput extends Message<ImageOutput> {
   ...
   * (optional, default INDEX)
   *
   * @generated from field: tc.ImageFileSuffix filename_suffix = 5;
   */
   ...
   * (optional)
   *
   * @generated from field: tc.ImageCodec image_codec = 6;
   */
   ...
   * required
   *
   * @generated from oneof tc.ImageOutput.output
   */
  output: {
    /**
     * @generated from field: tc.S3Upload s3 = 8;
     */
    value: S3Upload;
    case: "s3";
  } | {
    /**
     * @generated from field: tc.GCPUpload gcp = 9;
     */
    value: GCPUpload;
    case: "gcp";
  } | {
    /**
     * @generated from field: tc.AzureBlobUpload azure = 10;
     */
    value: AzureBlobUpload;
    case: "azure";
  } | {
    /**
     * @generated from field: tc.AliOSSUpload aliOSS = 11;
     */
    value: AliOSSUpload;
    case: "aliOSS";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ImageOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.S3Upload
 */
export class S3Upload extends Message<S3Upload> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.S3Upload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.GCPUpload
 */
export class GCPUpload extends Message<GCPUpload> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.GCPUpload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.AzureBlobUpload
 */
export class AzureBlobUpload extends Message<AzureBlobUpload> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.AzureBlobUpload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.AliOSSUpload
 */
export class AliOSSUpload extends Message<AliOSSUpload> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.AliOSSUpload";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "access_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "secret", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "region", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.StreamOutput
 */
export class StreamOutput extends Message<StreamOutput> {
  /**
   * required
   *
   * @generated from field: tc.StreamProtocol protocol = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.StreamOutput";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.EncodingOptions
 */
export class EncodingOptions extends Message<EncodingOptions> {
   ...
   * (default OPUS)
   *
   * @generated from field: tc.AudioCodec audio_codec = 5;
   */
   ...
   * (default H264_MAIN)
   *
   * @generated from field: tc.VideoCodec video_codec = 8;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.EncodingOptions";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.UpdateLayoutRequest
 */
export class UpdateLayoutRequest extends Message<UpdateLayoutRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateLayoutRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.UpdateStreamRequest
 */
export class UpdateStreamRequest extends Message<UpdateStreamRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.UpdateStreamRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "egress_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.ListEgressRequest
 */
export class ListEgressRequest extends Message<ListEgressRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "room_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.ListEgressResponse
 */
export class ListEgressResponse extends Message<ListEgressResponse> {
  /**
   * @generated from field: repeated tc.EgressInfo items = 1;
   */
  items: EgressInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ListEgressResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.StopEgressRequest
 */
export class StopEgressRequest extends Message<StopEgressRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.StopEgressRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "egress_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message tc.EgressInfo
 */
export class EgressInfo extends Message<EgressInfo> {
  ...
  /**
   * @generated from field: tc.EgressStatus status = 3;
   */
  ...
  /**
   * @generated from oneof tc.EgressInfo.request
   */
  request: {
    /**
     * @generated from field: tc.RoomCompositeEgressRequest room_composite = 4;
     */
    value: RoomCompositeEgressRequest;
    case: "roomComposite";
  } | {
    /**
     * @generated from field: tc.WebEgressRequest web = 14;
     */
    value: WebEgressRequest;
    case: "web";
  } | {
    /**
     * @generated from field: tc.ParticipantEgressRequest participant = 19;
     */
    value: ParticipantEgressRequest;
    case: "participant";
  } | {
    /**
     * @generated from field: tc.TrackCompositeEgressRequest track_composite = 5;
     */
    value: TrackCompositeEgressRequest;
    case: "trackComposite";
  } | {
    /**
     * @generated from field: tc.TrackEgressRequest track = 6;
     */
   ...
   *
   * @generated from oneof tc.EgressInfo.result
   */
  result: {
    /**
     * @generated from field: tc.StreamInfoList stream = 7 [deprecated = true];
     * @deprecated
     */
    ...
    /**
     * @generated from field: tc.FileInfo file = 8 [deprecated = true];
     * @deprecated
     */
    value: FileInfo;
    case: "file";
    ...
    /**
     * @generated from field: tc.SegmentsInfo segments = 12 [deprecated = true];
     * @deprecated
     */
    value: SegmentsInfo;
    case: "segments";
  ...
  /**
   * @generated from field: repeated tc.StreamInfo stream_results = 15;
   */
  streamResults: StreamInfo[] = [];

  /**
   * @generated from field: repeated tc.FileInfo file_results = 16;
   */
  fileResults: FileInfo[] = [];

  /**
   * @generated from field: repeated tc.SegmentsInfo segment_results = 17;
   */
  segmentResults: SegmentsInfo[] = [];

  /**
   * @generated from field: repeated tc.ImagesInfo image_results = 20;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.EgressInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "egress_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message tc.StreamInfoList
 * @deprecated
 */
export class StreamInfoList extends Message<StreamInfoList> {
  /**
   * @generated from field: repeated tc.StreamInfo info = 1;
   */
  info: StreamInfo[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.StreamInfoList";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.StreamInfo
 */
export class StreamInfo extends Message<StreamInfo> {
  ...
  /**
   * @generated from field: tc.StreamInfo.Status status = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.StreamInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from enum tc.StreamInfo.Status
 */
...
proto3.util.setEnumType(StreamInfo_Status, "tc.StreamInfo.Status", [
  { no: 0, name: "ACTIVE" },
  { no: 1, name: "FINISHED" },
  { no: 2, name: "FAILED" },
]);
...
/**
 * @generated from message tc.FileInfo
 */
export class FileInfo extends Message<FileInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.FileInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.SegmentsInfo
 */
export class SegmentsInfo extends Message<SegmentsInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.SegmentsInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.ImagesInfo
 */
export class ImagesInfo extends Message<ImagesInfo> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.ImagesInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.AutoParticipantEgress
 */
export class AutoParticipantEgress extends Message<AutoParticipantEgress> {
  /**
   * @generated from oneof tc.AutoParticipantEgress.options
   */
  options: {
    /**
     * (default H264_720P_30)
     *
     * @generated from field: tc.EncodingOptionsPreset preset = 1;
     */
    value: EncodingOptionsPreset;
    case: "preset";
  } | {
     ...
     * (optional)
     *
     * @generated from field: tc.EncodingOptions advanced = 2;
     */
    value: EncodingOptions;
    case: "advanced";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  /**
   * @generated from field: repeated tc.EncodedFileOutput file_outputs = 3;
   */
  fileOutputs: EncodedFileOutput[] = [];

  /**
   * @generated from field: repeated tc.SegmentedFileOutput segment_outputs = 4;
   */
  segmentOutputs: SegmentedFileOutput[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.AutoParticipantEgress";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message tc.AutoTrackEgress
 */
export class AutoTrackEgress extends Message<AutoTrackEgress> {
  ...
  /**
   * @generated from oneof tc.AutoTrackEgress.output
   */
  output: {
    /**
     * @generated from field: tc.S3Upload s3 = 2;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "tc.AutoTrackEgress";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "filepath", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 5, name: "disable_manifest", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "s3", kind: "message", T: S3Upload, oneof: "output" },
